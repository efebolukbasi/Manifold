...
- Markdown rendering for AI chat responses (code blocks, inline code, bold, italic, headings, lists)
- Draggable dividers between terminal panes for freeform resizing

## [0.1.0-12] - 2026-04-02

### Fixed

- Terminal and chat panes now fill all available window space instead of leaving whitespace
